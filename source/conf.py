...
#
html_theme_options = {
  'source_repository': 'https://github.com/driplineorg/dripline',
  'source_branch': 'main',
...
latex_documents = [
    (master_doc, 'Dripline.tex', u'Dripline Protocol',
...
man_pages = [
    (master_doc, 'dripline', u'Dripline Protocol Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Dripline', u'Dripline Protocol Documentation',
     author, 'Dripline', 'One line description of project.',
     'Miscellaneous'),
]
